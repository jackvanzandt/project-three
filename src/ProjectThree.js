...
render() {
  return html`
    ...
    <div class="tabs">
    <button class="tablinks" @click=${(e) => this.openTab(e, 'cold-start')}>Cold Start</button>
    <button class="tablinks" @click=${(e) => this.openTab(e, 'hmr-root')}>HMR (root changed)</button>
    <button class="tablinks" @click=${(e) => this.openTab(e, 'hmr-leaf')}>HMR (leaf changed)</button>
    <button class="tablinks" @click=${(e) => this.openTab(e, 'cold-build')}>Cold Build</button>
    </div>
